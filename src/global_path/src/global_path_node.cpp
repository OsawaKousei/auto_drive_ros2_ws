...
public:
  GlobalPathNode() : Node("global_path_node")
  {
    ...
    subscription_ = this->create_subscription<nav_msgs::msg::OccupancyGrid>(
        ...
        RCLCPP_INFO(this->get_logger(), "path planning started");
        ...
        RCLCPP_INFO(this->get_logger(), "path planning finished, elapsed time: %.2f ms", elapsed);
        ...
        RCLCPP_INFO(this->get_logger(), "path saved to %s", path_dir.c_str());
