...
namespace pure_pursuit
{
    ...
    PurePursuit::PurePursuit(const rclcpp::NodeOptions &options) : rclcpp::Node("publish", options)
    {
        ...
        this->declare_parameter<double>("look_forward_gain", 0.025);
        this->declare_parameter<double>("min_look_ahead_distance", 0.3);
        this->declare_parameter<double>("max_look_ahead_distance", 1.0);
        this->declare_parameter<double>("target_velocity", 0.75);   // m/s
        this->declare_parameter<double>("goal_radius", 0.25);       // Added goal_radius parameter
        this->declare_parameter<double>("k_c", 0.05);               // Control gain for curvature
        this->declare_parameter<double>("k_v_red", 0.05);           // Control gain for velocity reduction
